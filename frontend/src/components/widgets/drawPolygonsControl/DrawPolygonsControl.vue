...
<script setup lang="ts">
  ...
  import { drawingPolygonTools } from '@/components/widgets/drawPolygonsControl/Composables/DrawPolygons'
  ...
  const {
    ...
    drawingMode,
    editingMode,
  } = drawingPolygonTools(props.map, featureType)
